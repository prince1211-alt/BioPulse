...
import { bookAppointmentSchema, autoBookSchema, addSlotsSchema, removeSlotSchema, rescheduleSchema, updateStatusSchema } from '../schemas/appointment.schema.js';
...
router.post('/doctors/slots', validate(addSlotsSchema), addSlots);
router.delete('/doctors/slots', validate(removeSlotSchema), removeSlot);
